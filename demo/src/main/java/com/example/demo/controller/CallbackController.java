...
@RestController
@RequestMapping("/payment") // bỏ /api để zalopay gọi tới được
    ...
    public ResponseEntity<Map<String, Object>> handleZaloPayCallback(@RequestBody Map<String, Object> postdatajson) {
        ...
        try {
            ...
            if (!mac.equals(requestMac)) {
                ...
                Map<String, Object> datajson = (Map<String, Object>) new com.fasterxml.jackson.databind.ObjectMapper().readValue(data, Map.class);
