...
public class OrderAdminController {
    ...
    public ResponseEntity<OrderRequest> getOrderById(@RequestHeader("Authorization") String jwt, @PathVariable String orderRequestId)
        throws Exception {
    ...
    public ResponseEntity<String> updateOrderStatus(@RequestHeader("Authorization") String jwt, @PathVariable String orderRequestId,
    ...
    public ResponseEntity<String> editOrder(@RequestHeader("Authorization") String jwt, @PathVariable String orderRequestId,
